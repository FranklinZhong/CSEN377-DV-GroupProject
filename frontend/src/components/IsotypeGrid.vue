<!--
  ...
  Changes:
  - Butterfly chart: negative reviews on left, positive on right
  - Click a row to open an el-drawer with two columns of review quotes
  - Isotype figures kept to the right of each bar
-->
<template>
  <div class="iso-wrap">
